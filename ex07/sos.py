...
def to_morse(text: str) -> str:
    ...
    This function takes a text string,
    converts each character to uppercase,
    and maps it to its Morse code equivalent using
    the `MORSE_CODE` dictionary.
    ...
    :raises ValueError:
        If the string contains characters not
        present in the `MORSE_CODE` dictionary.
...
def main():
    ...
    - Validates that exactly one argument
    is provided (excluding the script name).
